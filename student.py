...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"D:\Coding\PBL data\Images_GUI\bg3.jpg")
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Branch",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        cou_combo["values"]=("Select Branch","CSE","IT","EE","ME","AIML")
        cou_combo.current(0)
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Dep","Branch","Year","Sem","Div","Gender","DOB","Mob-No","Address","Roll-No","Email","Teacher","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("Dep",text="Course")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Course" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            messagebox.showerror("Error","Please Fill All Fields are Required!",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(username='root', password='PHW#84#jeor',host='localhost',database='uday_pratap',port=3306)
        ...
        if self.var_dep.get()=="Select Course" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(username='root', password='PHW#84#jeor',host='localhost',database='uday_pratap',port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Course=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher_Name=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def reset_data(self):
        ...
        self.var_dep.set("Select Course"),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Course,Course,Year,Semester,Division,Gender,DOB,Mobile_No,Address,Roll_No,Email,Teacher_Name,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
